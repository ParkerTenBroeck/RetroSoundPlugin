...
public class OscilloscopePanel extends javax.swing.JPanel implements AudioOutInterface {
    ...
    public OscilloscopePanel(AudioOutInterface i) {
        this.iface = i;
    ...
    public void paint(final Graphics g) {
        g.drawImage(nextFrame, 0, 0, length, width, null);
    }
}
